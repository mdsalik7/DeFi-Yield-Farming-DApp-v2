...
//Helper Function - These functions convert to/from wei from/to eth. n - This is the number to convert.
...
Before adding the initYield with the savedYield, they're both multipliedby one. This turns the string balances
into numbers; otherwise, they concatenate.
*/
    ...
    /*
    This useEffect hook fetches the side effects of the loadHodlYield function in order to display the user's
    current yield.
    */
   ...
   /*
    ...
    beginning of the function call. Upon receipt, they're switched to 'on.'
    ...
    */
    ...
    /*
    These useEffect hooks are triggered by the preceding functions.
